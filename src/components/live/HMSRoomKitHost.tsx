...
export default function HMSRoomKitHost({ token, userName, onRoomEnd, onSessionStarted }: HMSRoomKitHostProps) {
        ...
        <div className="fixed top-4 left-1/2 transform -translate-x-1/2 z-50 bg-red-50 border border-red-200 rounded-lg p-4 max-w-md">
          <div className="flex items-center">
            ...
            <div className="ml-3">
              ...
              {isRetrying && (
                <p className="text-xs text-red-600 mt-1">Retrying connection...</p>
              )}
            </div>
            <button
