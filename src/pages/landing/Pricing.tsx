            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-6xl mx-auto mb-20">
                    {plans.map((plan, index) => (
                        <div
                            key={index}
                            className={`relative bg-white rounded-3xl border-2 p-8 transition-all duration-300 hover:-translate-y-2 shadow-lg ${plan.popular
                                ...
                                {plan.features.map((feature, idx) => (
                                    <li key={idx} className="flex items-start">
                                        <div className="w-5 h-5 bg-blue-100 rounded-full flex items-center justify-center mr-3 mt-1">
                                            <div className="w-2 h-2 rounded-full" style={{ backgroundColor: "#2369f4" }}></div>
                                        </div>
                ...
                {/* Feature Comparison */}
                <div className="bg-white rounded-3xl p-8 mb-20 border border-gray-200 shadow-lg">
                    <h2 className="text-3xl font-bold text-gray-900 text-center mb-12">Why Choose Global Academy?</h2>
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                        <div className="text-center">
                            <div className="w-16 h-16 bg-blue-100 rounded-2xl flex items-center justify-center mx-auto mb-4">
                                <img src="https://cdn-icons-png.flaticon.com/512/2092/2092063.png" alt="Security" className="w-8 h-8" />
                            </div>
                            <h3 className="text-xl font-bold text-gray-900 mb-2">Enterprise Security</h3>
                            <p className="text-gray-600">Bank-level encryption and blockchain certificate verification</p>
                        </div>
                        <div className="text-center">
                            <div className="w-16 h-16 bg-blue-100 rounded-2xl flex items-center justify-center mx-auto mb-4">
                                <img
                            ...
                            <p className="text-gray-600">Multi-tenant architecture that grows with your organization</p>
                        </div>
                        <div className="text-center">
                            <div className="w-16 h-16 bg-blue-100 rounded-2xl flex items-center justify-center mx-auto mb-4">
                                <img src="https://cdn-icons-png.flaticon.com/512/1067/1067566.png" alt="Support" className="w-8 h-8" />
                            </div>
                ...
                <div className="text-center mt-20">
                    ...
                    >
                        ...
                        <div className="flex flex-col sm:flex-row gap-4 justify-center">
                            <Link to="/register">
                                <Button className="bg-white/0.5 text-blue-600 hover:bg-blue-50 px-8 py-4 rounded-xl font-medium shadow-lg hover:scale-105 transition-all">
                                    Start Free Trial
                                </Button>
                            </Link>
                            <Link to="/contact">
                                <Button
                                    variant="outline"
                                    className="border-white/30 text-white hover:bg-white/10 px-8 py-4 rounded-xl font-medium bg-transparent border-2"
                                >
                                    Talk to Sales
                                </Button>
                            </Link>
