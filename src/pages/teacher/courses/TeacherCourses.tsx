...
import { Video, Calendar, Play, Copy, Clock, BookOpen, ClockIcon, MapPin, Mic, Users2, Clock3 } from "lucide-react"
...
const TeacherCourses = () => {
  ...
  const { byCourseId: enrollmentsByCourse } = useSelector((state: RootState) => state.enrollments)
    ...
    <div className="min-h-screen bg-gray-50 dark:bg-gray-900">
      <div className="max-w-6xl mx-auto px-4 py-6">
        <div className="mb-6 text-center">
          <h1 className="text-xl font-bold text-gray-900 dark:text-gray-100 mb-2">My Courses & Live Rooms</h1>
          <p className="text-gray-600 dark:text-gray-400 text-xs">View your assigned courses and join live sessions</p>
        </div>

        {teacherCourses.length === 0 ? (
          <div className="text-center py-12 bg-white dark:bg-gray-800 rounded-lg shadow-sm">
            <BookOpen className="h-12 w-12 text-gray-400 mx-auto mb-3" />
            <h3 className="text-base font-medium text-gray-900 dark:text-gray-100 mb-2">No Courses Assigned</h3>
            <p className="text-gray-600 dark:text-gray-400 text-xs">You don't have any courses assigned to you yet.</p>
          </div>
        ) : (
                    ...
                    <div className="flex items-start gap-4">
                      ...
                      <div className="flex-1 min-w-0">
                        <div className="flex items-start justify-between mb-3">
                          <div>
                            <h2 className="text-lg font-bold text-gray-900 dark:text-gray-100 mb-2">{course.title}</h2>
                    ...
                    {courseRooms.length === 0 ? (
                      <div className="text-center py-8 bg-gray-50 dark:bg-gray-700/50 rounded-lg">
                        ...
                        <p className="text-gray-600 dark:text-gray-400 text-xs">
                          Create your first live session room to start teaching.
                        </p>
                      </div>
                    ) : (
                              ...
                              <div className="flex items-start justify-between gap-4">
                                <div className="flex items-start gap-4 min-w-0 flex-1">
                                  ...
                                  <div className="flex-shrink-0 mt-1">
                                    <div
                                      className={`w-4 h-4 rounded-full ${getStatusColor(room.status)} flex items-center justify-center`}
                                    >
                                    ...
                                    <div className="grid grid-cols-1 md:grid-cols-3 gap-4 text-xs text-gray-600 dark:text-gray-400 mb-3">
                                      ...
                                      <div className="flex items-center gap-2">
                                        ...
                                        <div>
                                          ...
                                          <div>
                                            {new Date(room.start_time).toLocaleTimeString("en-US", {
                                              hour: "2-digit",
                                              minute: "2-digit",
                                              hour12: true,
                                            })}
                                      ...
                                      <div className="flex items-center gap-2">
                                        <Users2 size={14} className="text-purple-500 flex-shrink-0" />
                                        <div>
                                ...
                                <div className="flex flex-col items-end gap-3 self-start">
                                  ...
                                  <button
                                    ...
                                    className="px-4 py-2 bg-gradient-to-r from-green-500 to-emerald-600 text-white rounded-lg hover:from-green-600 hover:to-emerald-700 disabled:opacity-50 disabled:cursor-not-allowed flex items-center gap-2 transition-all duration-200 font-medium shadow-lg hover:shadow-xl transform hover:-translate-y-0.5 text-sm"
                                  >
